...
void getCompnentsDiscxn()
{
   ...
   // char pr[]="Computer graphics; ";
    glRasterPos2f(-0.5, -0.47);  // Adjust the x-coordinate
...
int main(int argc, char **argv)
{
	...
	glutCreateWindow("Demonstration of Object Penetration of a radia active element");
	init();
